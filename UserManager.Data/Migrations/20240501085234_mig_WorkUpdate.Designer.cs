...
namespace UserManager.Data.Migrations
{
    ...
    [Migration("20240501085234_mig_WorkUpdate")]
    partial class mig_WorkUpdate
    {
            ...
            modelBuilder.Entity("UserManager.Data.Entities.Users.UserWorks", b =>
                {
                    ...
                    b.HasOne("UserManager.Data.Entities.Users.User", null)
                        .WithMany("UserWorks")
                    ...
                    b.HasOne("UserManager.Data.Entities.Works.Work", null)
                        .WithMany("UserWorks")
